...
budgetPerDay:
  ...
  midRange: 65
  luxury: 130
gettingThere: "Take the Sprinter train from Amsterdam Centraal toward Uitgeest and get off at Zaandijk Zaanse Schans station (17 minutes, EUR 4.20). From the station, follow signs across the bridge — it is a 15-minute walk to the windmill area. Alternatively, bus 391 from Amsterdam Centraal stops directly at the village entrance."
highlights:
  - "Historic working windmills"
  - "Traditional clog-making workshop"
  - "Cheese-making demonstrations"
  - "Zaan River views and Dutch architecture"
  - "Zaans Museum and chocolate factory"
gradientColors: "from-#4E7C31 to-#5DADE2"
relatedDestinations:
  - haarlem
  - keukenhof
  - centrum
...
**Combining with other day trips:** Zaanse Schans pairs well with a morning or afternoon in [Haarlem](/destinations/haarlem), which is accessible by train from Zaandijk via a connection in Amsterdam (total journey about 40 minutes). In tulip season, some visitors combine Zaanse Schans with [Keukenhof](/destinations/keukenhof), though this makes for a very full day — better to dedicate separate days to each.
