...
budgetPerDay:
  ...
  midRange: 70
  luxury: 150
gettingThere: "Take bus 852 (Keukenhof Express) from Amsterdam RAI station or Schiphol Airport directly to Keukenhof. The ride from RAI takes 35 minutes, from Schiphol 25 minutes. Combi-tickets including bus transport and garden entry are available from EUR 33. By car, parking at Keukenhof costs EUR 6."
highlights:
  - "7 million tulips and spring flowers"
  - "Indoor flower exhibitions and pavilions"
  - "Historic windmill with panoramic views"
  - "Tulip field cycling routes"
  - "Seasonal opening: March through May only"
gradientColors: "from-#E91E63 to-#FF9800"
relatedDestinations:
  - haarlem
  - zaanse-schans
  - museum-quarter
...
For a post-Keukenhof dinner, return to Amsterdam and eat in [De Pijp](/destinations/de-pijp) or the [Jordaan](/destinations/jordaan), where the restaurant options are infinitely more varied.
...
**Combining with other day trips:** Keukenhof pairs naturally with [Haarlem](/destinations/haarlem), which is 30 minutes by bus and offers a charming lunch stop. If visiting [Zaanse Schans](/destinations/zaanse-schans) during the same trip, plan them on separate days to avoid exhaustion.
