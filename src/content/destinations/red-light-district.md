...
budgetPerDay:
  ...
  midRange: 130
  luxury: 300
gettingThere: "From Amsterdam Centraal, walk south along Damrak for 5 minutes, then turn left onto any side street heading east. The Red Light District begins along Warmoesstraat and Oudezijds Voorburgwal, a 7-minute walk from the station."
highlights:
  - "Oude Kerk — Amsterdam's oldest building"
  - "Museum Ons' Lieve Heer op Solder"
  - "Medieval architecture and canal views"
  - "Historic brown cafes"
  - "Hidden courtyards and almshouses"
gradientColors: "from-#8B0000 to-#D4A017"
relatedDestinations:
  - centrum
  - jordaan
  - plantage
...
Like the [Jordaan](/destinations/jordaan), De Wallen contains hidden hofjes — courtyard gardens enclosed by almshouses built by wealthy citizens to house the elderly and poor. These peaceful spaces are among the neighborhood's most surprising discoveries.
...
**Cafe de Sluyswacht** (Jodenbreestraat 1) is a leaning 17th-century lock-keeper's house perched on a canal bridge at the eastern edge of De Wallen, near the border with [Plantage](/destinations/plantage). The tiny terrace directly over the water is one of the most atmospheric drinking spots in the city. Beer EUR 4.50.
...
Staying in De Wallen puts you at the heart of the oldest part of the city with easy walking access to [Centrum](/destinations/centrum), [Plantage](/destinations/plantage), and the [Jordaan](/destinations/jordaan).
