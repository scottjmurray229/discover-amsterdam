...
budgetPerDay:
  ...
  midRange: 150
  luxury: 350
gettingThere: "You are already here — Amsterdam Centraal station sits at the northern edge of Centrum. Walk south along Damrak for 10 minutes to reach Dam Square."
highlights:
  - "Dam Square and the Royal Palace"
  - "Nieuwe Kerk exhibitions"
  - "Begijnhof hidden courtyard"
  - "Kalverstraat and Rokin shopping"
  - "Canal-side brown cafes"
gradientColors: "from-#1A2332 to-#0D7377"
relatedDestinations:
  - jordaan
  - red-light-district
  - museum-quarter
...
Kalverstraat has been Amsterdam's primary shopping street since the medieval period, and today it stretches from Dam Square south to the Munttoren (Mint Tower) as a pedestrianized corridor of international chains and Dutch retailers. It is not the most atmospheric shopping in Amsterdam — for that, head to the [Jordaan's Nine Streets](/destinations/jordaan) — but it is comprehensive and rain-proof, with covered passages like the Kalvertoren mall offering refuge from Amsterdam's famously unpredictable weather.
...
**Getting around:** Centrum is compact and best explored on foot. The tram network is useful for reaching the [Museum Quarter](/destinations/museum-quarter) (trams 2, 5, or 12 from Centraal) or [De Pijp](/destinations/de-pijp) (tram 24). Avoid taxis in the center — the narrow streets create gridlock, and a bike or your own feet will always be faster.
...
From Centrum, the rest of Amsterdam radiates outward along the canal rings. The [Jordaan](/destinations/jordaan) lies directly west, the [Red Light District](/destinations/red-light-district) is a five-minute walk east, and the grand southern neighborhoods housing the [Museum Quarter](/destinations/museum-quarter) and [Vondelpark](/destinations/vondelpark-area) are a 20-minute stroll or quick tram ride away. But do not rush — Centrum has centuries of stories hidden in its gables, courtyards, and canal reflections, and the best way to discover them is to simply walk without a plan and see where the city takes you.
